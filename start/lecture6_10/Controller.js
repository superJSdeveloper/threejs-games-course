...
class Controller{
    ...
    checkForGamepad(){
        ...
        window.addEventListener('gamepadconnected', function(e){gamepadConnect(e, true)}, false);
        window.addEventListener('gamepaddisconnected', function(e){gamepadConnect(e, false)}, false);
    }
